...
void LoadDestination(QueryResult * pResult)
{
    pResult = SD2Database.PQuery("SELECT id, name, pos_X, pos_Y, pos_Z, orient, mapid, "
                                "required_level, cost FROM sd2p_destinations");
    MDestination.clear();
